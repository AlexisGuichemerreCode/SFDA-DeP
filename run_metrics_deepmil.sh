...
python get_accuracy.py --cudaid 0 --split test --fold_dataset 0 --checkpoint_type best_classification --encoder_name resnet50 --sfda_method PixelCAM_classic --source_dataset CAMELYON512 --wsol_method DEEPMIL --path_pre_trained_source /export/livia/home/vision/Aguichemerre/CVPR_2026_SFDA_WSOL/source_model/GLAS/DEEPMIL/id_source_5_GLAS_DEEPMIL_250-tsk_STD_CL-ds_GLAS-fold_0-mag_None-runmode_search-mode-mth_DEEPMIL-spooling_DeepMil-arch_STDClassifier-ecd_resnet50 &
