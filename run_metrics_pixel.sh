...
python get_all_cam_metric_pixel.py \
    $COMMON_ARGS \
    --source_dataset GLAS \
    --source_fold 0 \
    ...
    --output results/GLAS_to_C17.png \
    --results_pickle results/GLAS_to_C17.pkl
...
python get_all_cam_metric_pixel.py \
    ...
    --output results/C17_0_to_C17.png \
    --results_pickle results/C17_0_to_C17.pkl
...
python get_all_cam_metric_pixel.py \
    ...
    --output results/C17_1_to_C17.png \
    --results_pickle results/C17_1_to_C17.pkl
...
python get_all_cam_metric_pixel.py \
    ...
    --output results/C17_2_to_C17.png \
    --results_pickle results/C17_2_to_C17.pkl
...
python get_all_cam_metric_pixel.py \
    ...
    --output results/C17_3_to_C17.png \
    --results_pickle results/C17_3_to_C17.pkl
...
python get_all_cam_metric_pixel.py \
    ...
    --output results/C17_4_to_C17.png \
    --results_pickle results/C17_4_to_C17.pkl
...
python get_all_cam_metric_pixel.py \
    ...
    --output results/C16_to_GLAS.png \
    --results_pickle results/C16_to_GLAS.pkl
...
python get_all_cam_metric_pixel.py \
    ...
    --sat_path /export/livia/home/vision/Aguichemerre/src_models_ICLR_2027/id_source_2_CAMELYON512_SAT_sat_5-tsk_STD_CL-ds_CAMELYON512-fold_0-mag_None-runmode_search-mode-mth_SAT-spooling_GAP-arch_SATClassifier-ecd_deit_sat_tiny_patch16_224 \
    --deepmil_path /export/livia/home/vision/Aguichemerre/src_models_ICLR_2027/id_source_8_CAMELYON512_DEEPMIL_2-tsk_STD_CL-ds_CAMELYON512-fold_0-mag_None-runmode_search-mode-mth_DEEPMIL-spooling_DeepMil-arch_STDClassifier-ecd_resnet50 \
    --output results/C16_to_C17.png \
    --results_pickle results/C16_to_C17.pkl

echo "============================================================"
echo "All CAM foreground-precision experiments finished."
echo "============================================================"
