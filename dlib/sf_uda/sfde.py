...
class Sfde(object):
    ...
    def filter_samples_2(self, samples, threshold=1):
    ...
    def forward_data(self,target_features, normal_sampler,tscam_features=None) -> dict:
        """
        Forward data through the model and return the output.
        """

        results = {
            'surrogate_sampler':  None,
            'target_features': None,
            'tscam_features': None,
        }	

        results['surrogate_sampler'] = normal_sampler
        results['target_features'] = target_features
        results['tscam_features'] = tscam_features
