...
__all__ = ['ContCrossEntropy', 'Entropy']


class ContCrossEntropy(nn.Module):
    """
    ...
    def __init__(self, sumit=True):
        ...
        """
        super(ContCrossEntropy, self).__init__()

        self.sumit = sumit

    def forward(self, p, q):
        """
        The forward function. It operates on batches.
...
class Entropy(ContCrossEntropy):
    """
