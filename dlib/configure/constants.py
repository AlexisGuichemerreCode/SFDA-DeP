...
SOURCE_MODELS_FD = 'source_models'

# SHOT distances
SHOT_COSINE = 'cosine'  # 1 - cosine similarity
SHOT_EUCL = 'euclidean'  # euclidean distance.
SHOT_DISTS = [SHOT_COSINE, SHOT_EUCL]
...
# GANs types
CGAN_ORIGINAL = 'CGAN'  # conditional GAN. https://arxiv.org/pdf/1411.1784.pdf
